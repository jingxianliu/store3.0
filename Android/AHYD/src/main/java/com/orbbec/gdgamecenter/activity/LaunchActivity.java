...
import com.orbbec.gdgamecenter.AHModule;
import com.orbbec.gdgamecenter.AHPresenter;
...
public class LaunchActivity extends HomeActivity {
    ...
    protected void onResume() {
        AHYDApplication.isInstallActivity = false;
