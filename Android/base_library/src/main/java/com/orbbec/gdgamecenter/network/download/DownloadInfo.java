...
public class DownloadInfo {
    ...
    public DownloadInfo(long id, DownloadState state, String url, String label, String fileSavePath, int progress, long fileLength, boolean autoResume, boolean autoRename) {
        this.id = id;
        this.state = state;
        this.url = url;
        this.label = label;
