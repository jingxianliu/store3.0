...
var _entry = __webpack_require__(57);
...
var staticImg = 'http://112.50.251.23:11091/img/picture';
exports.default = {
  data: function data() {
    return {
      staticImg: staticImg,
  ...
  computed: {
    status: function status() {
      var arr = ['normal', 'normal', 'normal', 'normal'];
      var index = this.focusCode.slice(1);
      arr[index] = 'active';
      return arr;
    }
  },
  ...
  methods: {
    autoFocus: function autoFocus(code) {
      ...
      if (code === 4) {
        ...
        var nextCode = this.getnextCode(now, code);
        if (nextCode) {
          this.lastCode = now;
    ...
    packIN: function packIN() {
      ...
      var url = this.createLink(pageName, params);
      this.isIndex = false;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    getnextCode: function getnextCode(now, code) {
      var seat = [[null, 'B1', 'B2', null], ['B0', 'B2', 'B2', null], ['B1', null, null, 'B1']];
    ...
    createLink: function createLink(page) {
      ...
      if (WXEnvironment.platform === 'Web') {
        // eslint-disable-line
        var tplPathList = (this.getUrlParam('_wx_tpl', location.href) || '').split('/');
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["bd"],
    attrs: {
      "src": (_vm.staticImg + "/bd.png")
    }
  }), _c('image', {
    class: [("win-" + (_vm.status[0]))],
    attrs: {
      "src": (_vm.staticImg + "/win-" + (_vm.status[0]) + ".png")
    }
  }), _c('image', {
    class: [("rule-" + (_vm.status[1]))],
    attrs: {
      "src": (_vm.staticImg + "/rule-" + (_vm.status[1]) + ".png")
    }
  }), _c('image', {
    class: [("park-" + (_vm.status[2]))],
    attrs: {
      "src": (_vm.staticImg + "/park-" + (_vm.status[2]) + ".png")
    }
  }), (_vm.popShow) ? _c('div', {
    staticClass: ["overlay"]
  }, [_c('image', {
    ...
    attrs: {
      "src": (_vm.staticImg + "/" + (this.lastCode === 'B1' ? 'rule' : 'win') + ".png")
    }
  }), _c('image', {
    class: [("close-" + (_vm.status[3]))],
    attrs: {
      "src": (_vm.staticImg + "/close-" + (_vm.status[3]) + ".png")
    }
  })]) : _vm._e()])
},staticRenderFns: []}
